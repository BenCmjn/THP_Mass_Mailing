...
def get_all_the_urls_of_val_doise_townhalls()
  page = Nokogiri::HTML(open("http://www.annuaire-des-mairies.com/val-d-oise.html"))# On va utiliser Nokogiri pour parcourir la page "val d'oise" de "annuaire-des-mairies.com"
...
def get_the_email_of_a_townhal_from_its_webpage(cities)
  ...
  cities.each do |city|
    ...
    page = Nokogiri::HTML(open("http://annuaire-des-mairies.com/95/#{url_cities}.html"))  # pour pouvoir l'insérer dans cet url, que Nokogiri va scrapper, une fois de plus
    mail = page.css('p:contains("@")').text.gsub(' ','')# et on récupère les <p> contenant des "@" puisque un email est forcément avec un "@" ;)
...
cities = get_all_the_urls_of_val_doise_townhalls()
